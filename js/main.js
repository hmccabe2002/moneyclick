...
function updateDisplay()
{
	...
	document.getElementById("mpc").innerHTML = numeral(money_per_click*10).format("$0.00a");
	document.getElementById("mpc_upgrade_cost").innerHTML = numeral(costc).format("$0.00a");
	document.getElementById("mps").innerHTML = numeral(money_per_second*10).format("$0.00a");
